...
var _require2 = __webpack_require__(21),
    SlackDAO = _require2.SlackDAO,
    HistoryDAO = _require2.HistoryDAO;

module.exports.get = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(event, context, callback) {
    var token, slackDao, muted, channels, responseBuilder;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return slackDao.getMutedChannels();

          case 4:
            muted = _context.sent;
            _context.next = 7;
            return slackDao.getAllChannels();

          case 7:
            channels = _context.sent;
            responseBuilder = new ResponseBuilder(callback, { channels: channels, muted: muted });
...
module.exports.set = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(event, context, callback) {
    var data, muttedChnnelsIds, _event$requestContext, token, userId, slackDao, historyDao, responseBuilder, muted, res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            muttedChnnelsIds = data.muted_channels;
            _event$requestContext = event.requestContext.authorizer, token = _event$requestContext.token, userId = _event$requestContext.userId;
            slackDao = new SlackDAO(token);
            historyDao = new HistoryDAO(userId);
            responseBuilder = new ResponseBuilder(callback);
            _context2.prev = 6;
            _context2.next = 9;
            return slackDao.setMutedChannels(muttedChnnelsIds);

          case 9:
            muted = _context2.sent;
            _context2.next = 12;
            return historyDao.appendUserHistory(muted);
...
/***/ })
/******/ ])));
//# sourceMappingURL=slack.muted.js.map